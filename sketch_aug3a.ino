...
/*
  ...
  {
    Serial.println("im pub_client.connected ");
    // delay(1000);
 ...
 lo_maindialog.m_display();
  ...
  Serial.print(S1); // 0=nicht ausgeloest, 1=ausgeloest
  Serial.println(S1A);
  if (S1 == 1)
  {
    Serial.println("********************************************");
